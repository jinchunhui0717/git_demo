/*
* AlgTaskDetailInspectExample.java
...
public class AlgTaskDetailInspectExample {
    ...
    /**
     *  构造查询条件:dbo.alg_task_detail_inspect
     */
    public AlgTaskDetailInspectExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    /**
     *  设置排序字段:dbo.alg_task_detail_inspect
     *
    ...
    /**
     *  获取排序字段:dbo.alg_task_detail_inspect
     */
    ...
    /**
     *  设置过滤重复数据:dbo.alg_task_detail_inspect
     *
    ...
    /**
     *  是否过滤重复数据:dbo.alg_task_detail_inspect
     */
    ...
    /**
     *  获取当前的查询条件实例:dbo.alg_task_detail_inspect
     */
    ...
    /**
     *  创建一个查询条件:dbo.alg_task_detail_inspect
     */
    ...
    /**
     *  内部构建查询条件对象:dbo.alg_task_detail_inspect
     */
    ...
    /**
     *  清除查询条件:dbo.alg_task_detail_inspect
     */
    public void clear() {
        oredCriteria.clear();
        orderByClause = null;
    ...
    /**
     * @Title dbo.alg_task_detail_inspect表的实体类
     * @version 1.0
     * @Author rafael
