...
public class AlgEquipTypeExample {
    ...
    /**
     *  构造查询条件:dbo.alg_equip_type
     */
    public AlgEquipTypeExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    /**
     *  设置排序字段:dbo.alg_equip_type
     *
    ...
    /**
     *  获取当前的查询条件实例:dbo.alg_equip_type
     */
